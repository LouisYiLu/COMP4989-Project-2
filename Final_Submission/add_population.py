...
# Complete CSV
data = pd.read_csv(os.path.abspath('dataset/complete.csv'))
data = data.drop('Unnamed: 0', axis=1)

# Get & Format Population Data
populations = pd.read_csv(
    os.path.abspath('dataset/population_by_country_2020.csv')
)
...
# SAVE DATA TO CSV
data.to_csv(os.path.abspath('dataset/complete_with_population.csv'))

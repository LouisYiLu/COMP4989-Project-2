...
def main():
    # read 3 files
    policy_tracker = pd.read_csv('dataset/OxCGRT_latest.csv')
    mobility = pd.read_csv('dataset/Global_Mobility_Report.csv')
    covid_track_data = pd.read_csv("dataset/owid-covid-data.csv")
    ...
    result.to_csv("dataset/complete.csv")
